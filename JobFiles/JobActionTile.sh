...
./sim -o $OutPut -GeomConfig 11 -Muon -nDetected -Volume -TileV0 -ForceBottomLine -nX 2 -nodesec 5 -Znode 9 -LYSO_L $LYSOLen -rnd 0 -SZloc $Nsections -Ypos {2.9-2.9-2.9-2.9-2.9-2.9-2.9-2.9-2.9-2.9} -ESRbackpainted -Acte -RESIN_W 1.5 -gunmesh 10 10 -runevt 100 -Muon
